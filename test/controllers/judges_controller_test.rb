...
class JudgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create judge" do
    assert_difference('Judge.count') do
      post judges_url, params: { judge: { court_id: @judge.court_id, entity_id: @judge.entity_id } }
    end
  ...
  test "should update judge" do
    patch judge_url(@judge), params: { judge: { court_id: @judge.court_id, entity_id: @judge.entity_id } }

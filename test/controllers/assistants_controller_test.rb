...
class AssistantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assistant" do
    assert_difference('Assistant.count') do
      post assistants_url, params: { assistant: { entity_id: @assistant.entity_id, lawyer_id: @assistant.lawyer_id } }
    end
  ...
  test "should update assistant" do
    patch assistant_url(@assistant), params: { assistant: { entity_id: @assistant.entity_id, lawyer_id: @assistant.lawyer_id } }

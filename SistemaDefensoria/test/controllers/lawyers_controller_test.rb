...
class LawyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lawyer" do
    assert_difference('Lawyer.count') do
      post lawyers_url, params: { lawyer: { entitie_id: @lawyer.entitie_id, type_lawyer: @lawyer.type_lawyer } }
    end
  ...
  test "should update lawyer" do
    patch lawyer_url(@lawyer), params: { lawyer: { entitie_id: @lawyer.entitie_id, type_lawyer: @lawyer.type_lawyer } }

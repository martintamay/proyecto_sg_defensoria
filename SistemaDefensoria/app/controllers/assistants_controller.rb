class AssistantsController < ApplicationController
  ...
  def new
    ...
    @assistant.entity = Entity.new 
    @assistant.user = User.new 
  end
  ...
  private
    ...
    def assistant_params
      params.require(:assistant).permit(:lawyer_id, entity_attributes:[:id, :name, :last_name, :phone, :birthdate, :email],user_attributes:[:id, :email, :password, :password_confirmation])
    end
end
